    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{ width: 120, height: 15, marginBottom: 8 }}
        />
        {/* Badge */}
        <div
          className="skeleton-bone"
        ...
        <div
          className="skeleton-bone"
          style={{ width: "55%", maxWidth: 720, height: 40 }}
        />
        <div
          className="skeleton-bone"
          style={{ width: "35%", maxWidth: 460, height: 40 }}
        />
        {/* Meta row */}
      ...
      <div style={{ marginTop: 80, marginBottom: 80 }}>
        <div
          className="skeleton-bone"
          style={{ width: 180, height: 24, marginBottom: 32 }}
        />
        <div
          style={{
            display: "grid",
          ...
          {[0, 1, 2].map((i) => (
            ...
            >
              ...
              >
                <div
                  className="skeleton-bone"
                  style={{ width: 70, height: 22, borderRadius: 100 }}
                />
                <div
                  className="skeleton-bone"
                  style={{ width: "85%", height: 17 }}
                />
                <div
                  className="skeleton-bone"
                  style={{ width: "65%", height: 17 }}
                />
                <div
                  className="skeleton-bone"
                  style={{ width: 120, height: 13, marginTop: 4 }}
                />
              </div>
            </div>
          ))}
