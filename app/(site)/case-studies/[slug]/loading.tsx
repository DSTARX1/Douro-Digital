    ...
    <div style={{ position: "relative", zIndex: 1, background: "var(--bg)" }}>
      ...
      >
        ...
        <div
          ...
          style={{ width: 500, maxWidth: "80%", height: 80 }}
        />
        {/* Tagline */}
        <div
          className="skeleton-bone"
          style={{ width: 400, maxWidth: "60%", height: 24 }}
        />
        {/* Video */}
        <div
          className="skeleton-bone"
      ...
      <main>
        <div style={{ padding: "60px 48px", maxWidth: 900, margin: "0 auto" }}>
          <div
            className="skeleton-bone"
            style={{ width: "90%", height: 20, marginBottom: 16 }}
          />
          <div
            className="skeleton-bone"
        ...
        <div style={{ padding: "60px 48px" }}>
          <div
            className="skeleton-bone"
            style={{ width: 180, height: 28, marginBottom: 40 }}
          />
          <div
            style={{
              display: "grid",
